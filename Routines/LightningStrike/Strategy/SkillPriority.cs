...
namespace ExilePrecision.Routines.LightningStrike.Strategy
{
    public class SkillPriority
    {
            ...
            SkillMonitor skillMonitor)
        {
            ...
            var lightningStrike = FindSkill(availableSkills, "LightningStrike");
            if (lightningStrike != null && skillMonitor.CanUseSkill(lightningStrike))
